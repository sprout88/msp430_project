...
void main(void)
{
    ...
    while(1)
    {
        ...
        else if((P6IN & BIT6) == 0) // key4
        {
            key = 4;
        }
        else if((P6IN & BIT5) == 0) // key7
        {
            key = 7;
        }
        else if((P6IN & BIT4) == 0) // key10
        {
            key = 10;
        }
        ...
        else if((P6IN & BIT6) == 0) // key5
        {
            key = 5;
        }
        else if((P6IN & BIT5) == 0) // key8
        {
            key = 8;
        }
        else if((P6IN & BIT4) == 0) // key0
        {
            key = 0;
        }
        ...
        else if((P6IN & BIT6) == 0) // key6
        {
            key = 6;
        }
        else if((P6IN & BIT5) == 0) // key9
        {
            key = 9;
        }
        else if((P6IN & BIT4) == 0) // key11
        {
            key = 11;
        }
    }
